...
/// Iterator which converts `tabor_terminal` damage information into renderer damaged rects.
...
mod tests {
    ...
    fn add_viewport_damage() {
        ...
        let height = 5;
        let width = 10;
        let size_info = SizeInfo::new(viewport_height, viewport_height, 5., 5., 0., 0., 0., true);

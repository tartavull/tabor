...
complete -c tabor -n "__fish_tabor_needs_command" -f -a "agent-browser" -d 'Agent-browser CLI compatibility shim'
...
complete -c tabor -n "__fish_tabor_using_subcommand help; and not __fish_seen_subcommand_from msg agent-browser migrate help" -f -a "msg" -d 'Send a message to the Tabor socket'
complete -c tabor -n "__fish_tabor_using_subcommand help; and not __fish_seen_subcommand_from msg agent-browser migrate help" -f -a "agent-browser" -d 'Agent-browser CLI compatibility shim'
complete -c tabor -n "__fish_tabor_using_subcommand help; and not __fish_seen_subcommand_from msg agent-browser migrate help" -f -a "migrate" -d 'Migrate the configuration file'
complete -c tabor -n "__fish_tabor_using_subcommand help; and not __fish_seen_subcommand_from msg agent-browser migrate help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
